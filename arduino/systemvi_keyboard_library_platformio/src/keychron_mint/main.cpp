...
void setup() {
  ...
  keyboard->setNormalKeycap(0 ,0,   (char[]){static_cast<char>(KEY_BACKSPACE),'\0','\0','\0'}  ,13,0,  4,0);

  keyboard->setNormalKeycap(13,1,   (char[]){static_cast<char>(KEY_TAB),'\0','\0','\0'}        ,0 ,1,  2,0);
  ...
  keyboard->setNormalKeycap(13,2,   (char[]){static_cast<char>(KEY_CAPS_LOCK),'\0','\0','\0'}  ,0 ,2,    3,0);
  ...
  keyboard->setNormalKeycap(0 ,2,   (char[]){static_cast<char>(KEY_RETURN),'\0','\0','\0'}     ,12,2,    5,0);

  keyboard->setNormalKeycap(13,3,   (char[]){static_cast<char>(KEY_LEFT_SHIFT),'\0','\0','\0'}    ,0 ,3,    5,0);
  ...
  keyboard->setNormalKeycap(1 ,3,   (char[]){static_cast<char>(KEY_RIGHT_SHIFT),'\0','\0','\0'}   ,11,3,    6,0);

  keyboard->setNormalKeycap(13,4,   (char[]){static_cast<char>(KEY_LEFT_CTRL),'\0','\0','\0'}     ,0 ,4,    1,0);
  keyboard->setNormalKeycap(12,4,   (char[]){static_cast<char>(KEY_LEFT_GUI),'\0','\0','\0'}      ,1 ,4,    1,0);
  keyboard->setNormalKeycap(11,4,   (char[]){static_cast<char>(KEY_LEFT_ALT),'\0','\0','\0'}      ,2 ,4,    1,0);
  keyboard->setNormalKeycap(8 ,4,   (char[]){' ','\0','\0','\0'}               ,3 ,4,    7,0);
  keyboard->setNormalKeycap(4 ,4,   (char[]){static_cast<char>(KEY_RIGHT_ALT),'\0','\0','\0'}     ,4 ,4,    1,0);
  keyboard->setNormalKeycap(3 ,4,   (char[]){static_cast<char>(KEY_RIGHT_GUI),'\0','\0','\0'}     ,5 ,4,    1,0);
  keyboard->setNormalKeycap(2 ,4,   (char[]){static_cast<char>(KEY_MENU),'\0','\0','\0'}          ,6 ,4,    1,0);
  keyboard->setNormalKeycap(1 ,4,   (char[]){static_cast<char>(KEY_RIGHT_CTRL),'\0','\0','\0'}    ,7 ,4,    1,0);

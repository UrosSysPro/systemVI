...
val threeDPrintingRoute = Route.static(ThreeDPrintingPage, root / "3dprinting" / endOfSegments)
val knittingRoute       = Route.static(KnittingPage, root / "knitting" / endOfSegments)
val origamiRoute        = Route.static(OrigamiPage, root / "origami" / endOfSegments)

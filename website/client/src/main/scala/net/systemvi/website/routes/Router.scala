...
object Router extends Router[Page](
  routes = List(
    ...
    hearthRoute,
    threeDPrintingRoute,
    threeDPrintedProductDetailsRoute,
    threeDPrintedProductsRoute,
    knittingRoute,
    origamiRoute,
    userProfileRoute,
    catanCardsRoute,
  ...
  deserializePage = pageData => {
    ...
    val page = List(
      ...
      json.as[ThreeDPrintedProductsPage.type],
      json.as[ThreeDPrintedProductDetailsPage],
      json.as[KnittingPage.type],
      json.as[OrigamiPage.type],
      json.as[UserProfilePage.type],
      json.as[CatanCardsPage.type],
    ).flatMap{
